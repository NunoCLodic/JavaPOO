...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/chat.png"))); // NOI18N
        ...
        jMenuItem_config.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        jMenuItem_sair.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        jMenuItem_add_est.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.ALT_DOWN_MASK));
        ...
        jMenuItem_ed_est.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.ALT_DOWN_MASK));
        ...
        jMenuItem_exl_est.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.ALT_DOWN_MASK));
        ...
        jMenuItem_pesq_est.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.ALT_DOWN_MASK));
        ...
        jMenuItem_add_mot.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.SHIFT_DOWN_MASK));
        ...
        jMenuItem_ed_mot.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.SHIFT_DOWN_MASK));
        ...
        jMenuItem_ex_mot.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.SHIFT_DOWN_MASK));
        ...
        jMenuItem_pes_mot.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.SHIFT_DOWN_MASK));
        ...
        jMenuItem_add_via.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        jMenuItem_ed_via.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        jMenuItem_ex_via.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        jMenuItem_pes_via.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.ALT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jDesktopPane, javax.swing.GroupLayout.DEFAULT_SIZE, 503, Short.MAX_VALUE)
        );
    ...
    private void jMenuItem_add_estActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_add_estActionPerformed
        ...
        JInternalFrame estacionamentoExistente = null;

        // Procurar se já existe o frame "Adicionar Estacionamento"
        for (JInternalFrame frame : jDesktopPane.getAllFrames()) {
            if ("Adicionar Estacionamento".equals(frame.getTitle())) {
                estacionamentoExistente = frame;
            } else {
                // Se não for o frame desejado, mantê-lo minimizado ou deixá-lo em paz
                try {
                    if (!frame.isIcon()) {
                        frame.setIcon(true); // Minimiza sem fechar
                    }
        ...
        if (estacionamentoExistente != null) {
            try {
                if (estacionamentoExistente.isIcon()) {
                    estacionamentoExistente.setIcon(false); // Restaura se estiver minimizado
                }
                estacionamentoExistente.setSelected(true); // Traz para frente
                estacionamentoExistente.setVisible(true);  // Garante visibilidade
            } catch (PropertyVetoException e) {
                e.printStackTrace();
            }
        } else {
            // Criar e adicionar frame somente se ainda não existe
            ...
            JComponent desktopIcon = addEstacionamentoFrame.getDesktopIcon();
// Define novo tamanho: largura = 250, altura = 30
            desktopIcon.setSize(250, desktopIcon.getHeight());
            desktopIcon.setPreferredSize(new Dimension(250, desktopIcon.getHeight()));
    ...
    private void jMenuItem_add_motActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_add_motActionPerformed
        ...
        JInternalFrame condutorExistente = null;

        // Procurar por frame existente
        for (JInternalFrame frame : jDesktopPane.getAllFrames()) {
            if ("Adicionar Condutor".equals(frame.getTitle())) {
                condutorExistente = frame;
            } else {
                try {
                    if (!frame.isIcon()) {
                        frame.setIcon(true); // Minimiza os outros
                    }
                } catch (PropertyVetoException e) {
                    e.printStackTrace();
                }
        ...
        if (condutorExistente != null) {
            try {
                if (condutorExistente.isIcon()) {
                    condutorExistente.setIcon(false); // Restaura se estiver minimizado
                }
                condutorExistente.setSelected(true); // Traz à frente
                condutorExistente.setVisible(true);  // Garante visibilidade
            } catch (PropertyVetoException e) {
                e.printStackTrace();
            }
        } else {
            ...
            JComponent desktopIcon = addCondutorFrame.getDesktopIcon();
// Define novo tamanho: largura = 250, altura = 30
            desktopIcon.setSize(250, desktopIcon.getHeight());
            desktopIcon.setPreferredSize(new Dimension(250, desktopIcon.getHeight()));
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        JInternalFrame homeExistente = null;

        // Verifica se já existe o frame "Home"
        for (JInternalFrame frame : jDesktopPane.getAllFrames()) {
            if ("Home".equals(frame.getTitle())) {
                homeExistente = frame;
            } else {
                try {
                    if (!frame.isIcon()) {
        ...
        if (homeExistente != null) {
            try {
                if (homeExistente.isIcon()) {
                    homeExistente.setIcon(false); // Restaura se estiver minimizado
                }
                homeExistente.setSelected(true);   // Foco no frame
                homeExistente.setVisible(true);    // Garante visibilidade
            } catch (PropertyVetoException e) {
                e.printStackTrace();
            }
        } else {
            ...
            homeFrame.setBounds(0, 0, jDesktopPane.getWidth(), jDesktopPane.getHeight());
            homeFrame.setLayout(new BorderLayout());

            JLabel label = new JLabel("BEM-VINDO À TELA DE CONTROLE");
            label.setHorizontalAlignment(SwingConstants.CENTER);
            label.setFont(new Font("Arial", Font.BOLD, 20)); // Pequeno toque visual
            homeFrame.add(label, BorderLayout.CENTER);

            homeFrame.setDefaultCloseOperation(JInternalFrame.DISPOSE_ON_CLOSE);
            homeFrame.setVisible(true);

            JComponent desktopIcon = homeFrame.getDesktopIcon();
// Define novo tamanho: largura = 200, altura = 30
            desktopIcon.setSize(200, desktopIcon.getHeight());
            desktopIcon.setPreferredSize(new Dimension(200, desktopIcon.getHeight()));
    ...
    private void jMenuItem_add_viaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_add_viaActionPerformed
        ...
        JInternalFrame transporteExistente = null;

        // Verifica se já existe o frame "Adicionar Transporte"
        for (JInternalFrame frame : jDesktopPane.getAllFrames()) {
            if ("Adicionar Transporte".equals(frame.getTitle())) {
                transporteExistente = frame;
            } else {
                try {
                    if (!frame.isIcon()) {
                        frame.setIcon(true); // Minimiza os outros frames
                    }
                } catch (PropertyVetoException e) {
                    e.printStackTrace();
                }
        ...
        if (transporteExistente != null) {
            try {
                if (transporteExistente.isIcon()) {
                    transporteExistente.setIcon(false); // Restaura se minimizado
                }
                transporteExistente.setSelected(true);  // Dá foco
                transporteExistente.setVisible(true);   // Garante visibilidade
            } catch (PropertyVetoException e) {
                e.printStackTrace();
            }
        } else {
            // Criar novo frame "Adicionar Transporte"
            ...
            JComponent desktopIcon = addTransporteFrame.getDesktopIcon();
// Define novo tamanho: largura = 250, altura = 30
            desktopIcon.setSize(250, desktopIcon.getHeight());
            desktopIcon.setPreferredSize(new Dimension(250, desktopIcon.getHeight()));
        ...
        UIManager.put("InternalFrame.titlePaneHeight", 30); // Se for suportado
