...
public class PIPG {
    ...
    public static void main(String[] args) {
        ...
        v[0] = new Viatura("AA-BB-12", "Renaul", "Megane", 2009, "Azul", 2.0, 1.0, 1.5, c[0]);
        v[1] = new Viatura("BB-BB-12", "Renaul", "Zoe", 2019, "Branca", 2.5, 1.0, 1.75, c[1]);
...
//MANIPULACAO VIATURA    
        ...
        e[1].ativar();
        c[0].desocuparEstacionamento(v[0], e[1]);
