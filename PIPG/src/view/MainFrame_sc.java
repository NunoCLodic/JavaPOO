...
public class MainFrame_sc extends javax.swing.JFrame {
    ...
    private void jMenuItem_add_estActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_add_estActionPerformed
        Add_est_sc telaAddEst_sc = new Add_est_sc();
        telaAddEst_sc.setDefaultCloseOperation(Add_est_biblioteca.EXIT_ON_CLOSE);

        jDesktopPane_add_mot.add(telaAddEst_sc);

        telaAddEst_sc.setSize(800, 600);

//        telaAddEst.setContentPane(jDesktopPane_add_mot);
        telaAddEst_sc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainFrame_sc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
