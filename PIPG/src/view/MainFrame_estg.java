...
public class MainFrame_estg extends javax.swing.JFrame {

    public MainFrame_estg() {
        initComponents();
    }
    ...
    private void jMenuItem_add_estActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_add_estActionPerformed
        Add_est_estg telaAddEst_estg = new Add_est_estg();
        telaAddEst_estg.setDefaultCloseOperation(Add_est_biblioteca.EXIT_ON_CLOSE);

        jDesktopPane_add_mot.add(telaAddEst_estg);

        telaAddEst_estg.setSize(800, 600);

//        telaAddEst.setContentPane(jDesktopPane_add_mot);
        telaAddEst_estg.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainFrame_estg().setVisible(true);
            }
        });
    }
